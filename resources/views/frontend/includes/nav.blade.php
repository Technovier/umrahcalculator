<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <img src="https://www.tawafgroup.com/wp-content/uploads/2019/03/90.png" alt="Na">
            ...
            @else
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuUser">
                        @can('view backend')
                            <a href="{{ route('admin.dashboard') }}" class="dropdown-item">@lang('Admin')</a>
                        @endcan
